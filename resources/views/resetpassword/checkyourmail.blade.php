...
<head>
    ...
    <title>Please Check Your Mail</title>
        ...
        <div class="col-md-12 login-form">
            <div class="login_form_in">
                <div class="auth_branding">
                    <a class="auth_branding_in" href="#"><img src="https://res.cloudinary.com/procraftstudio/image/upload/v1613964589/Procraft-Studio-Logo-1_tnfxuj.jpg" alt='Procraft Studio'></a>
                </div>
              <h1 class="auth_title text-left">Please Check Your Mail</h1>
